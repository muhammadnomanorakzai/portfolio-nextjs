    ...
    <section
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <motion.div
          ...
          className="absolute top-1/4 left-1/4 w-80 h-80 bg-primary-500/10 rounded-full blur-2xl"
        />
      </div>

      <div className="max-w-5xl mx-auto container-padding relative z-5 py-4">
        <SectionHeading
          title="About Me"
          subtitle="Passionate Full Stack Developer focused on delivering clean, scalable, and user-centric digital solutions"
        />

        {/* Top Content: Image & Intro */}
        <div className="grid lg:grid-cols-2 gap-8 items-center mb-10">
          ...
          <AnimatedSection direction="left">
            <div className="space-y-6">
              <h3 className="text-1xl lg:text-2xl font-bold bg-gradient-to-r from-primary-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                ...
                {stats.map((stat, index) => {
                  ...
                  return (
                    <div
                      key={stat.label}
                      ref={ref}
                      className="text-center p-3 rounded-2xl bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
        ...
        {/* Bottom Content: Two Column Timeline */}
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-8">
                {education.map((edu, idx) => (
                  <div
                    key={idx}
                    className="relative pl-8 border-l-2 border-primary-600/20 group hover:border-primary-600 transition-colors">
          ...
          <AnimatedSection direction="up">
            <div className="space-y-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-2xl font-bold">Professional Experience</h4>
              </div>
              ...
              <div className="space-y-8">
                {experiences.map((exp, idx) => (
                  <div
                    key={idx}
                    className="relative pl-8 border-l-2 border-purple-600/20 group hover:border-purple-600 transition-colors">
