    ...
    <>
      <section
        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10">
          ...
          <div className="flex flex-wrap justify-center items-center gap-1 p-1 bg-gray-100/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-2xl w-fit mx-auto mb-16 border border-gray-200/50 dark:border-gray-700/50">
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-6 py-2.5 text-sm font-bold transition-colors duration-300 rounded-xl ${
                    isActive
    ...
    <motion.div
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-gray-800 hover:border-primary-500/30">
        <div className="relative h-56 overflow-hidden">
          ...
          />
          <div className="absolute top-4 left-4 px-3 py-1 bg-black/60 backdrop-blur-md rounded-lg text-[10px] uppercase font-bold tracking-widest text-white border border-white/10 z-10">
            {project.category}
          </div>
        </div>
  ...
  return (
    <motion.div
      ...
      <motion.div
        ...
        className="bg-white dark:bg-gray-900 rounded-[2.5rem] max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative"
        ...
        <div className="relative h-72 md:h-[450px] w-full">
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 p-3 bg-black/20 hover:bg-black/40 backdrop-blur-xl rounded-full text-white transition-all z-20 border border-white/20">
            <XMarkIcon className="w-5 h-5" />
          </button>
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
          <div className="absolute bottom-10 left-10">
            <span className="px-4 py-1.5 bg-primary-600 text-white text-[10px] font-black rounded-lg uppercase tracking-[0.2em]">
              {project.category}
            </span>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-2">
              {project.technologies?.map((tech) => (
                <span
                  key={tech}
                  className="px-5 py-2.5 bg-gray-50 dark:bg-gray-800 dark:text-gray-200 rounded-xl text-sm font-bold border border-gray-100 dark:border-gray-700">
                  {tech}
                </span>
              ))}
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-16">
            {project.live_url && (
              <Button
                ...
                className="flex-1 py-5 text-base shadow-xl shadow-primary-600/20">
